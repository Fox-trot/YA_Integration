...
Процедура ХарактеристикиПолучить(Параметры, Характеристики)
	...
	|	ПОДСТРОКА(ЕСТЬNULL(Полы.Значение, ЕСТЬNULL(Разделения.Наименование, """")), 1, 20) КАК Пол,
	...
	|ИЗ
	|	РегистрСведений.СоответствиеРеквизитовИМ КАК Реквизиты
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК Товар
