...
Функция КарточкиПолучить()
	...
	|	ЕСТЬNULL(ПОДСТРОКА(Цветы.Значение, 1, 100), СписокКарточек.Цвет) КАК Цвет,
	...
	|		ПО СписокКарточек.Номенклатура = Реквизиты.Номенклатура
	...
	|		ПО СписокКарточек.Номенклатура = ЦеныНоменклатуры.Номенклатура
	|ГДЕ
